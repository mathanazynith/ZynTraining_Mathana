page 50127 ZYN_UpdateFieldCard
{
    PageType = Card;
    ApplicationArea = All;
            ...
            group("Update Field Information")
            {
                ...
                field("Field Name"; FieldName)
                {
                    ...
                    begin
                        ...
                        if Page.RunModal(Page::"ZYN_Field Buffer List", TempBuffer, SelectCust) = Action::LookupOK then begin
                ...
                field("Record Name"; RecordName)
                {
                    ...
                    begin
                        ...
                        if Page.RunModal(Page::"ZYN_Field Buffer List", TempValueBuffer, RecNo) = Action::LookupOK then begin
