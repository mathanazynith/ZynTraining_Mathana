page 50109 "ZYN_IncomeCategoryFactBox"
{
    PageType = CardPart;
        ...
        area(content)
        {
            cuegroup("Income Summary")
            {
                ...
                field(Monthly; Monthly)
                {
                    ...
                    trigger OnDrillDown()
                    var
                        IncomeList: Page "ZYN_Income Tracker List";
    ...
    local procedure SetMonthlyFilter(var Income: Record "ZYN_IncomeTracker")
    var
        StartDate: Date;
        EndDate: Date;
    ...
    local procedure SetQuarterlyFilter(var Income: Record "ZYN_IncomeTracker")
    var
        StartDate: Date;
        EndDate: Date;
        SelectedMonth: Integer;
    ...
    local procedure SetHalfYearlyFilter(var Income: Record "ZYN_IncomeTracker")
var
    StartDate: Date;
    EndDate: Date;
begin
    ...
    local procedure SetYearlyFilter(var Income: Record "ZYN_IncomeTracker")
    var
        StartDate: Date;
        EndDate: Date;
        CurrentYear: Integer;
