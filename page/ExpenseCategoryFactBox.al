page 50149 "ZYN_ExpenseCategoryFactBox"
{
    PageType = CardPart;
        ...
        area(content)
        {
            cuegroup("Expense Summary")
            {
                ...
                field(Monthly; Monthly)
                {
                    ...
                    trigger OnDrillDown()
                    var
                        ExpenseList: Page "ZYN_Expense Tracker List";
    ...
    local procedure SetMonthlyFilter(var Expense: Record "ZYN_Expense Tracker")
    var
        StartDate: Date;
        EndDate: Date;
    ...
    local procedure SetQuarterlyFilter(var Expense: Record "ZYN_Expense Tracker")
    var
        StartDate: Date;
        EndDate: Date;
        SelectedMonth: Integer;
    ...
    local procedure SetHalfYearlyFilter(var Expense: Record "ZYN_Expense Tracker")
var
    StartDate: Date;
    EndDate: Date;
begin
    ...
    local procedure SetYearlyFilter(var Expense: Record "ZYN_Expense Tracker")
    var
        StartDate: Date;
        EndDate: Date;
        CurrentYear: Integer;
