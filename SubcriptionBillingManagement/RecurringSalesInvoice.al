table 50300 "ZYN_Recurring Sales Invoice"
{
    ...
    fields
    {
        ...
        field(2; "Subscription ID"; Code[20])
        {
            ...
            TableRelation = ZYN_Subscription."Subscription ID";
            DataClassification = CustomerContent;
    ...
    trigger OnInsert()
    var
        LastIndex: Record "ZYN_Recurring Sales Invoice";
        LastId: Integer;
        LastIdStr: Code[20];
    begin
    ...
    var
        Sub: Record ZYN_Subscription;
        Plan: Record "ZYN_Monthly Subscription Plan";
    begin
        "Plan Amount" := 0;
