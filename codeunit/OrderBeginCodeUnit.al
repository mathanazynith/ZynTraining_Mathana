codeunit 50131 "PostedBeginningTextHandler"
{
    ...
    var
        SourceBuffer: Record "Extended Table";
        TargetBuffer: Record "Extended Table";
        NewLineNo: Integer;
        Customer:Record Customer;
        Textcode: Enum "Text Code Enum";
    begin
    ...
    local procedure GetNextLineNo(Buffer: Record "Extended Table"; DocNo: Code[20]; CustNo: Code[20]; Sel: Enum "Text Code Enum"): Integer
    var
        MaxLineNo: Integer;
    begin
        Buffer.Reset();
    ...
    var
        ...
        Buffer: Record "Extended Table";
        Customer: Record Customer;
        NewLineNo: Integer;
        SelectionType: Enum "Text Code Enum";
    begin
